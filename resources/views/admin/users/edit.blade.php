...
<style>
    ...
    .form-card { background: #fff; border-radius: 12px; padding: 28px; border: 1px solid #e0e8e2; max-width: 640px; }
...
<div class="dashboard-wrap">
    <aside class="sidebar">
        ...
        <a href="{{ route('admin.users.index') }}" class="sidebar-link {{ request()->routeIs('admin.users.index') || request()->routeIs('admin.users.edit') ? 'active' : '' }}">👥 All Users</a>
    ...
    <main class="main-content">
        <div class="page-title">✏️ Edit User — {{ $user->name }}</div>
        <div class="form-card">
